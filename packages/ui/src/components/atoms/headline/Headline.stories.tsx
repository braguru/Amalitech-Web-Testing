...
const meta: Meta<HeadlineProps> = {
    ...
    argTypes: {
        ...
        color: {
            ...
            table: {
                type: {summary: 'base-black | base-white | base-orange | base-light-blue | base-green | base-yellow | base-red | base-ultra-marine'},
                defaultValue: {summary: 'base-black'}
            }
        },
        as: {
            control: {type: 'radio', options: ['display-1', 'display-2', 'display-3']},
