...
describe('Headline Component', () => {
  ...
  it('applies the correct display style (display1)', () => {
    render(<Headline level={3} as="display1">Styled Heading</Headline>);
    const headingElement = screen.getByRole('heading', { level: 3 });
    expect(headingElement).toHaveClass('text-heading-xxxl font-bold');
  ...
  render(<Headline level={1} color="primary-500">Custom Color Heading</Headline>);
  const headingElement = screen.getByRole('heading', { level: 1 });
