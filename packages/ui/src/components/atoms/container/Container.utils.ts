...
export const getFlattenedColors = <T extends Record<string, unknown>>(colorObj: T, prefix = ''): Record<string, string> => Object.keys(colorObj).reduce((acc, key) => {
        ...
        if (typeof value === 'object' && value !== null && !Array.isArray(value)) {
            ...
            Object.assign(acc, getFlattenedColors(value as unknown as Record<string, unknown>, newKey));
        } else {
